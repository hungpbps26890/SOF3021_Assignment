...
<footer>
   ...
   <!-- JS -->
   <script type="text/javascript" src="/assets/user/js/jquery-1.11.2.min.js"></script>      <!-- jQuery -->
   <script type="text/javascript" src="/assets/user/js/templatemo-script.js"></script>      <!-- Templatemo Script -->  