...
public interface ReportDAO extends JpaRepository<Report, Integer> {
	...
	@Query("SELECT new Report(o.createDate, count(o), sum(o.totalPrice)) "
			+ "FROM Order o "
			+ "WHERE day(o.createDate) = ?1 AND o.paymentStatus = ?2 "
			+ "GROUP BY o.createDate "
			+ "ORDER BY sum(o.totalPrice) DESC")
	...
	@Query("SELECT new Report(o.createDate, count(o), sum(o.totalPrice)) "
			+ "FROM Order o "
			+ "WHERE month(o.createDate) = ?1 AND o.paymentStatus = ?2 "
			+ "GROUP BY o.createDate "
			+ "ORDER BY sum(o.totalPrice) DESC")
	...
	@Query("SELECT new Report(year(o.createDate), count(o), sum(o.totalPrice)) "
			+ "FROM Order o "
			+ "WHERE year(o.createDate) = ?1 AND o.paymentStatus = ?2 "
